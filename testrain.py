...
# Train on 1 GPU and 8 images per GPU. We can put multiple images on each
    ...
    NUM_CLASSES = 1 + 7  # background + 3 shapes注意這裏要是你類別，我是七個類別，所以爲7，外加背景1個
...
dataset_root_path="/Users/yjf/work/datasets/labelme/"###存放訓練數據的目錄
